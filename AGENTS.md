...
We are building a Duolingo-inspired AI language learning mobile app but for learning and revising science formulas using Expo.
...
- it represents a clear UI concept like `LessonCard`, `XPBar`, `FormulaCard`, or `PrimaryButton`
